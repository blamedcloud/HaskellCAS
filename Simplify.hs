...
simplify (c :*: (a :^: b))
                                 | a == c = ((simplify a) :^: (simplify (b :+: Const 1))) 
simplify (a :*: b) 
                                 | a == b = (simplify a) :^: Const 2
simplify ((a :*: b) :*: (c :*: d))
                                 | a == c = (simplify b) :*: (simplify d) :*: ((simplify a) :^: Const 2)
                                 | a == d = (simplify b) :*: (simplify c) :*: ((simplify a) :^: Const 2)
                                 | b == c = (simplify a) :*: (simplify d) :*: ((simplify b) :^: Const 2)
                                 | b == d = (simplify a) :*: (simplify c) :*: ((simplify b) :^: Const 2)
